    ...
    <div className="p-6 bg-[#f5f3ff] min-h-screen relative">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {rewardCards.map((card, index) => (
          ...
          >
              <button className="text-xl m-auto px-3 py-1 bg-purple-800 text-white rounded-md font-medium">Click to Confirm</button>
            </div>
        ))}
      </div>
      ...
      {selectedTask && (
        <div className="fixed inset-0 bg-black bg-opacity-40 flex justify-center items-center z-50">
          <div className="bg-white w-[90%] max-w-lg rounded-xl shadow-lg p-6">
            ...
            <p className="text-sm text-gray-600 mb-4">Fill out your MSME details to earn GLL Ions</p>
            ...
            <div className="grid gap-3">
              <input name="businessName" value={formData.businessName} onChange={handleChange} className="border p-2 rounded" placeholder="Business Name" />
              <input name="gstin" value={formData.gstin} onChange={handleChange} className="border p-2 rounded" placeholder="GSTIN" />
              <input name="businessType" value={formData.businessType} onChange={handleChange} className="border p-2 rounded" placeholder="Business Type" />
